...
- ![AWS][aws logo] AWS DISCOVERY DAY - Strategies and Tools to Perform Large-Scale Migrations _([Asseco Academy](https://academy.asseco.pl/) 2022)_ [Cert Local](2022/AWS_DISCOVERY_DAY_-_Strategies_and_Tools_to_Perform_Large-Scale_Migrations.pdf)
- ![AWS][aws logo] AWS - Bezpieczeństwo _([awsmasters.pl](https://www.awsmasters.pl/) 2022)_
- ![AWS][aws logo] AWS - Konteneryzacja _([awsmasters.pl](https://www.awsmasters.pl/) 2022)_
- ![AWS][aws logo] AWS Certified Cloud Practitioner _([Amazon Web Services Training and Certification](https://www.credly.com/organizations/amazon-web-services/badges) 2022)_ - [Cert Local](2022/AWS_Certified_Cloud_Practitioner_certificate.pdf) - [Cert Remote](https://www.credly.com/badges/f9d24e7b-fb83-44c6-87fe-5ea109f0e7e3/public_url)
...
- ![Security][security logo] Bezpieczeństwo API REST _(Securitum 2023)_ - [Cert Local](2023/Bezpieczenstwo_API_REST.pdf)
...
- ![IT][it logo] ITIL® Foundation Certificate in IT Service Management _(Axelos 2023)_ - [Cert Local](2023/ITIL4_Foundation.pdf)
...
[it logo]: https://img.shields.io/static/v1?label=&color=3A3A42&message=IT&logo=docsify&logoColor=white&style=flat